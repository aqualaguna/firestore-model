...
var CreateLayer = /** @class */ (function (_super) {
    ...
    CreateLayer.prototype.save = function () {
        ...
        if (this.docRef) {
            ...
            if (this.timestamp) {
                temp.updated_at = _1_base_1.now;
            }
            return this.docRef.set(temp).then(function (d) { return Promise.resolve(true); });
        }
        else {
            if (this.timestamp) {
                temp.updated_at = temp.created_at = _1_base_1.now;
            }
            //create the data
            if (this.id && typeof this.id === 'string') {
                // if the id is set then use the id and update
                // @ts-ignore
                return this.constructor.collection().doc(this.id).set(temp).then(function (d) { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                ...
                // autogenerate id
                //@ts-ignore
                return this.constructor.collection().add(temp).then(function (d) { return __awaiter(_this, void 0, void 0, function () {
                    var _a;
    ...
    CreateLayer.create = function (data) {
        ...
        if (data instanceof Array) {
            return Promise.all(data.map(function (item) {
                temp = {};
                for (var _i = 0, _a = Object.keys(attribute); _i < _a.length; _i++) {
                    var key = _a[_i];
                    // @ts-ignore
                ...
                return _this.collection().add(temp).then(function (d) { return __awaiter(_this, void 0, void 0, function () {
                    var res, _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
            ...
            return this.collection().add(temp).then(function (d) { return __awaiter(_this, void 0, void 0, function () {
                var res, _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
