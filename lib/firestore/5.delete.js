...
var DeleteLayer = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
                        return [4 /*yield*/, this.constructor.deleting(this.id)];
                    case 1:
                        // @ts-ignore
                        if (!(_a.sent())) {
                            throw new Error("deleting permission denied.");
                        }
                        return [2 /*return*/, this.docRef ? this.docRef.delete().then(function () {
                                self.docRef = null;
                                // @ts-ignore
                                _this.constructor.deleted(_this.id);
                                return true;
                            }).catch(function (d) { return false; }) : false];
                }
            });
        });
    };
     ...
     * @param id documentID
     */
    DeleteLayer.isExists = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // check the id
                return [2 /*return*/, this.collection().doc(id).get().then(function (d) { return d.exists; }).catch(function () { return false; })];
            });
        });
    };
    /**
     ...
     */
    DeleteLayer.deleteAll = function () {
        var batch = this.firestore().batch();
        return this.collection().listDocuments().then(function (val) {
    ...
    */
    DeleteLayer.deleting = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    DeleteLayer.deleted = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, true];
            });
